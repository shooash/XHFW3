...
public class WindowHolder2{
   ...
   // public int cachedRotation;
	...
	public WindowHolder2(final Activity sActivity){
		this(sActivity, MainXposed.mPref);
	}
	
	public WindowHolder2(final Activity sActivity, final WindowHolder2 defaultLayout){
		this(sActivity, defaultLayout, MainXposed.mPref);
	}
	
    public WindowHolder2(final Activity sActivity, final XSharedPreferences mPref){
...
//					|| Util.isFlag(flags, Intent.FLAG_ACTIVITY_NO_HISTORY);
	...
	public WindowHolder2(final Activity sActivity, final WindowHolder2 defaultLayout, final XSharedPreferences mPref) {
        mPref.reload();
        cachedOrientation=Util.getScreenOrientation(sActivity.getApplicationContext());	
...
//			|| Util.isFlag(flags, Intent.FLAG_ACTIVITY_NO_HISTORY);
	...
	public void copy (final WindowHolder2 sWindowHolder){
...
//    }
    ...
    public void restore(WindowHolder2 sWindowHolder){
        alpha = sWindowHolder.alpha;
        width = sWindowHolder.width;
        height = sWindowHolder.height;
		if(width==0) width=-1;
